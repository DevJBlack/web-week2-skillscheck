...
// Code Here
let groceries = ['milk','cereal','cookies']
...
function checkGroceryCount(x){
  ...
  return checkGroceryCount(groceries.length)
}
checkGroceryCount(groceries.length)
//////////////////STEP 6////////////////////
