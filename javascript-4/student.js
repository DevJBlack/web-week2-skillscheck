...
// CODE HERE
let faveColors = ['#4D4DFF','black','gray']
...
let me = {
  firstName: 'Devin',
  superHeroName: 'Bodacious Smiley',
  homeTown: 'Payson',
  superPowers: ['Super Speed', 'Forgive all', 'Super Smarts'],
  profileImage(){ 
...
// CODE HERE
let regularName = 'Devin'
let superName = 'Bodacious Smiley'
let homeTown = 'Payson'
