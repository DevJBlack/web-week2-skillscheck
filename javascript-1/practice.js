...
// Code Here
let doubled = myNumbers.map(function(ele,index,arr){
	return ele * 2
})
doubled
...
// Code Here
let filtered = myNumbers.filter(function(ele,index,arr){
	return ele > 100
})
filtered
...
// Code Here
let myNumbersIndex = []
myNumbers.forEach(function(ele, i){
...
// Code Here
let forTheLoveOfGeorge = notGeorge.map(function(ele,index,arr){
	return ele = 'George'
})
...
// Code Here
let enemies = people.filter(function(ele,index,arr){
	return ele.friend === false
})
enemies
...
// Code Here
let totallyAwesome = people.reduce(function(arr,cur){
	return arr += cur.awesomeLevel
}, 0)
totallyAwesome